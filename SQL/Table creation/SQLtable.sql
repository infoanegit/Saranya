use exercise
CREATE TABLE authors(au_id varchar(50) PRIMARY KEY ,au_lname VARCHAR(50),au_fname VARCHAR(50),phone varchar(20),address VARCHAR(50),city VARCHAR(50),state VARCHAR(50),zip INT ,isActive bit)

CREATE TABLE  publishers(pub_id INT PRIMARY KEY ,pub_name VARCHAR(50),city VARCHAR(50),state VARCHAR(50),country VARCHAR(50))

CREATE TABLE  titles(title_id varchar(50) PRIMARY KEY ,
title VARCHAR(250),
type VARCHAR(150),
...
CREATE TABLE  titleauthor(au_id varchar(50) FOREIGN KEY REFERENCES authors(au_id),
title_id  varchar(50) FOREIGN KEY REFERENCES titles(title_id),
au_ord int,
royaltyper int)

CREATE TABLE stores(stor_id INT PRIMARY KEY,
...
CREATE TABLE sales(stor_id INT FOREIGN KEY REFERENCES stores(stor_id),
ord_num varchar(50),
ord_date date,
qty int,
payterms varchar(50),
...
CREATE TABLE  roysched(title_id VARCHAR(50) FOREIGN KEY REFERENCES titles(title_id),
lorange int,
hirange int,
royalty int
)

create table  discounts(discounttype varchar(50),
...
CREATE TABLE pub_info(pub_id int PRIMARY KEY,
logo varchar(50),
pr_info varchar(60))
...
job_lvl int,
pub_id int FOREIGN KEY REFERENCES pub_info(pub_id),
hire_date date)
